const RESTAURANTS = [
  ...
  { name: 'Per Se', neighborhood: 'Columbus Circle', borough: 'Manhattan', cuisine: 'French / American', stars: 3, criteria: '["michelin"]', platform: 'Tock', reservation_release: 'Monthly drop', url: 'https://www.exploretock.com/perse' },
  ...
  // === 2-Star Michelin (14) ===
  { name: 'Aquavit', neighborhood: 'Midtown East', borough: 'Manhattan', cuisine: 'Scandinavian', stars: 2, criteria: '["michelin"]', platform: 'Tock', reservation_release: 'Monthly drop', url: 'https://www.exploretock.com/aquavit' },
  ...
  { name: 'Jungsik', neighborhood: 'TriBeCa', borough: 'Manhattan', cuisine: 'Korean', stars: 2, criteria: '["michelin"]', platform: 'Tock', reservation_release: 'Monthly drop', url: 'https://www.exploretock.com/jungsik' },
  ...
  { name: 'Blue Hill', neighborhood: 'Greenwich Village', borough: 'Manhattan', cuisine: 'Farm-to-Table', stars: 2, criteria: '["michelin"]', platform: 'Tock', reservation_release: 'Monthly drop', url: 'https://www.exploretock.com/bluehillnyc' },
  ...
  { name: 'Estela', neighborhood: 'Nolita', borough: 'Manhattan', cuisine: 'Mediterranean', stars: 1, criteria: '["michelin"]', platform: 'Tock', reservation_release: 'Monthly drop', url: 'https://www.exploretock.com/estela' },
  ...
  { name: 'The Musket Room', neighborhood: 'Nolita', borough: 'Manhattan', cuisine: 'New American', stars: 1, criteria: '["michelin"]', platform: 'Tock', reservation_release: 'Monthly drop', url: 'https://www.exploretock.com/themusketroom' },
  ...
  { name: '63 Clinton', neighborhood: 'Lower East Side', borough: 'Manhattan', cuisine: 'American', stars: 1, criteria: '["michelin"]', platform: 'Resy', reservation_release: '14 days ahead', url: 'https://resy.com/cities/new-york-ny/venues/sixty-three-clinton' },
